...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/Slotheve/V2Ray_ws-tls_bash/main/install.sh" && chmod +x install.sh && bash install.sh
```
### 注意事项
